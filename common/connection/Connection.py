    ...
    def __init__(self, host="rabbitmq", port=5672, virtual_host="/", user=None, password=None):
        try:
            ...
            if user and password:
                ...
                parameters = pika.ConnectionParameters(host=host, port=port, virtual_host=virtual_host, credentials=credentials, heartbeat=1800, blocked_connection_timeout=300)
            else:
